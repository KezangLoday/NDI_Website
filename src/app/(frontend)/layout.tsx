...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    <html
      lang="en"
      // Next 16 no longer overrides `scroll-behavior` on navigation; without this, route changes glide to the top rather than jumping.
    ...
    >
      <body>
        ...
        <div className="relative isolate min-h-screen">
          ...
          {/* data-ndi-content marks the flow content for useCircuitBands, which must measure this rather than the document: the band layers are absolutely positioned and count toward document height, so sizing them from it would mean they could never shrink again. */}
          {/* overflow-x-clip, not hidden: the footer's glow pools and its grid floor are drawn wider than the page on purpose, and without a clip they widened the document by 45px. */}
