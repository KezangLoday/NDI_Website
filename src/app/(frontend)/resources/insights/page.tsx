...
export default async function InsightsPage() {
  /* The tabs come from the categories that actually have something published under them, so a new category appears without a code change and an empty one does not render a dead end. */
