 ...
 *
 * Logos sharing a `slot` occupy the same box and cross-fade between each
 * other. Slot order is significant: the carousel's per-column timing table is
 * indexed by it, which is what keeps the columns off the same beat.
 */
