...
export function ViewAllLink({ href, children }: { href: string; children: ReactNode }) {
  return (
    <Link
      href={href}
      className="ndi-va inline-flex h-[38px] flex-none items-center gap-[7px] rounded-[10px] border border-white/[0.12] bg-[#18202c] px-[15px] font-display text-[13.5px] font-semibold text-strong transition-[background,color] duration-[280ms] ease-ndi"
    >
      {children}
