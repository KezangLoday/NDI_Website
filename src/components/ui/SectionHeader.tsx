 ...
 *
 * Keeps the design's resting outline, but drops it on hover rather than turning
 * it mint the way the design did. The fill, the mint glow beneath, the inner
 * bottom light and the arrow slide all remain.
 */
