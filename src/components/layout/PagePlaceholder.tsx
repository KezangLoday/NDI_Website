...
export function PagePlaceholder({
  ...
  return (
    <section className="mx-auto flex min-h-[70svh] max-w-[1200px] flex-col items-start justify-center px-8 pb-24 pt-[184px]">
      ...
      <Link
        href="/"
        className="ndi-va mt-8 inline-flex h-[38px] flex-none items-center gap-[7px] rounded-[10px] border border-white/[0.12] bg-[#18202c] px-[15px] font-display text-[13.5px] font-semibold text-strong transition-[background,color] duration-[280ms] ease-ndi"
      >
        Back to home
